...
ESD_FUNCTION(ESD_CoDl_SetupBitmap, Type = uint8_t, Attributes = ESD_CORE_EXPORT, DisplayName = "Setup Bitmap", Category = EveRenderFunctions)
...
ESD_FUNCTION(ESD_CoDl_SetupRomFont, Type = uint8_t, Attributes = ESD_CORE_EXPORT, DisplayName = "Setup ROM Font", Category = EveRenderFunctions)
...
ESD_FUNCTION(ESD_CoDl_SetupFont, Type = uint8_t, Attributes = ESD_CORE_EXPORT, DisplayName = "Setup Font", Category = EveRenderFunctions)
